...
import com.obhl.game.config.FeignClientConfig;

@FeignClient(name = "api-gateway", url = "${application.config.api-gateway-url:http://localhost:8000}", configuration = FeignClientConfig.class)
