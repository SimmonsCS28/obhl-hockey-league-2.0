-- Create GM user account for Phillip Pedracine (Team Maroon)
...
VALUES ('phillip_pedracine', 'pedracine_phillip@hotmail.com', '$2a$10$jIAqogaM3c2.lHqqkGKlV.xpl02ZD/A4fRWJYesmP5jFUZpZnBrKO', 'GM', 19, TRUE, TRUE, NOW(), NOW())
