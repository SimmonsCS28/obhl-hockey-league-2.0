                            ...
                            {filteredGames.map(game => {
                                ...
                                return (
                                    <tr key={game.id}>
                                        ...
                                        <td>
                                            {isCompleted ? (
                                                <Link to={`/game/${game.id}/recap`} state={{ from: '/gm/schedule', backLabel: 'Schedule', fromTeamId: resolvedTeamId }} className="btn-action-small preview-btn">Recap</Link>
                                            ) : (
                                                <Link to={`/game/${game.id}/preview`} state={{ from: '/gm/schedule', backLabel: 'Schedule', fromTeamId: resolvedTeamId }} className="btn-action-small preview-btn">Preview</Link>
                                            )}
                                        </td>
                                    </tr>
                                );
